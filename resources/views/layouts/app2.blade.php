...
<head>
    ...
    <link rel="stylesheet" href="{{asset('css/conexist.css')}}">
    ...
    <header>
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="nav-der">
                <div class="perfil">
                    <div class="dropdown">
                        <button class="btn btn-dark btn-sm dropdown-toggle bt-sv" type="button" id="dropdownMenuButton2" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="dropdownMenuButton2">
                            ...
                            <li>
                                <form class="form-sesion"action="{{route('logout')}}" method="post">
                                    @csrf
                                    <button class="btn btn-dark bt-sv">
